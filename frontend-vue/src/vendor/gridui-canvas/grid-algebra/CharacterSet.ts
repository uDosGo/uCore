/* ═══════════════════════════════════════════════════════════════════
   CharacterSet — Teletext G0 character map
   ═══════════════════════════════════════════════════════════════════
   Maps teletext character codes (0-255) to Unicode code points.
   Provides the bridge between GridUI's teletext rendering and
   the symbol registry.

   Ported from: frontend/archive/src/surfaces/gridui/grid-algebra/CharacterSet.ts
   ═══════════════════════════════════════════════════════════════════ */

// ─── Teletext G0 Character Set ─────────────────────────────────
...
/**
 * Resolve a teletext character code to a display character.
 */
export function resolveTeletextChar(code: number): string {
  return TELETEXT_G0[code] ?? ' '
}
