/* ═══════════════════════════════════════════════════════════════════
   ...
   the input. This makes them safe for Vue reactive state updates.
   ...
   Operations:
     ...
     fill        — Fill a region with a character and colours
     writeString — Write a string into a buffer at a position

   Ported from: frontend/archive/src/surfaces/gridui/grid-algebra/GridTransform.ts
   ═══════════════════════════════════════════════════════════════════ */

import { type GridBuffer, type GridCell, createCell, cloneBuffer, getDimensions } from './GridCell'
 ...
 * Returns a new buffer of size (w × h). Clamps to buffer boundaries.
 */
