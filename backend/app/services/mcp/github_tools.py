...
class GitHubTools:
    ...
    def publish_release(self, repo_name: str, version: str | None = None,
    ...
    def sync_repos(self, local_dir: str | None = None) -> dict:
    ...
    def create_pr(self, repo_name: str, title: str | None = None,
                  body: str | None = None, base: str = "main") -> dict:
    ...
    def actions_status(self, repo_name: str | None = None,
    ...
    def _detect_version(self, repo_name: str) -> str | None:
    ...
    def _get_current_branch(self, repo_name: str) -> str | None:
...
_tools_instance: GitHubTools | None = None


def get_github_tools(token: str | None = None) -> GitHubTools:
