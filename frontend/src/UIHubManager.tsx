...
const FALLBACK_REGISTRY: SurfaceDef[] = [
  ...
  { id: 'userver',   name: 'uServer',        subtitle: 'Server Management',         description: 'uServer backend services — secret server, OAuth, sync, and surface definitions.', port: 0, color: '#58a6ff', icon: 'layers',      status: 'stopped', cell: 'L100-AA10-0103-1', embedded: true, route: '/userver' },
