/* ═══════════════════════════════════════════════════════════════════
   ...
   Features story library, variable binding, and mode switching.
   ═══════════════════════════════════════════════════════════════════ */
...
const SAMPLE_STORIES: StoryEntry[] = [
  {
    ...
    icon: 'person',
    steps: [
      { id: 'welcome', title: 'Welcome to uDos', description: 'Configure your $Variables and connect to the Secret Store.', type: 'info' },
      ...
      { id: 'complete', title: 'Setup Complete!', description: 'Your profile has been configured. $Variables synced.', type: 'info' },
    ],
  },
  {
    id: 'workflow-intro', title: 'Workflow Orientation', description: 'A walkthrough of the workflow surface.', stepCount: 4, mode: 'marp',
    color: '#22c55e', icon: 'account_tree',
    steps: [
      { id: 's1', title: 'Workflow Surface', description: 'Your mission control center.', type: 'info' },
      { id: 's2', title: 'Mission Control', description: 'Monitor missions, stats, and health.', type: 'info' },
      { id: 's3', title: 'Tasks & Projects', description: 'Manage tasks with Kanban boards.', type: 'info' },
      { id: 's4', title: 'Binder Compiler', description: 'Drop files to compile binders.', type: 'info' },
    ],
  },
  {
    id: 'system-admin', title: 'System Admin Guide', description: 'Overview of system pages, tools, secrets.', stepCount: 3, mode: 'marp',
    color: '#f0883e', icon: 'build',
    steps: [
      { id: 'a1', title: 'System Surface', description: 'Access /system — pages, tools, secrets.', type: 'info' },
  ...
  {
    id: 'variables-demo', title: '$Variables Collection', description: 'Learn how $Variables work.', stepCount: 4, mode: 'typeform',
    color: '#a855f7', icon: 'tune',
    steps: [
      ...
      { id: 'v3', title: 'Unique ID', description: 'Auto-generated. View in Variables panel.', type: 'info' },
      { id: 'v4', title: 'All Set', description: 'Available as {{variable}} or $variable.', type: 'info' },
    ],
  },
]
...
export default function S101StoryBuilder() {
  ...
  return (
    <USystemPage page={101} title="Story Builder" subtitle="Typeform-styled forms & Marp-styled slideshows">
      <div className="story-builder">
        ...
        {mode === 'typeform' && activeStory && (
          <div className="story-content">
            <div className="story-mode-toggle" style={{ borderTop: '1px solid var(--story-border)' }}>
              <button className="story-step-btn" onClick={handleBackToLibrary}><Icon name="arrow_back" size={14} /> Library</button>
