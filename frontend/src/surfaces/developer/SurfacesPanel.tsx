...
const CANONICAL_SURFACES: SurfaceEntry[] = [
  ...
  { id: 'ucode', name: 'uCode', route: '/ucode', type: 'canonical', icon: 'terminal', color: '#58a6ff', description: 'Terminal + Teletext + Grid' },
  ...
  { id: 'gridui', name: 'GridUI (Legacy)', route: '/gridui', type: 'orphan', icon: 'grid_view', color: '#8b949e', description: 'Redirected to /ucode' },
