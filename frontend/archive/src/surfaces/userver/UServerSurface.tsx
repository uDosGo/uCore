...
import { FilepickerSidebar, SidebarNavItem } from '../../components/FilepickerSidebar'
...
// ─── Snacks/Snackbar Tab ──────────────────────────────────────────────
// Simplified: Link to dedicated SnackMachine surface for full management
function SnacksTab() {
  return (
    <div style={{ height: '100%', overflow: 'auto', padding: 16 }}>
      <div className="userver-card" style={{ margin: '0 16px 16px' }}>
        <div className="userver-card-header">
          <h3><Icon name="restaurant_menu" /> Snacks & Snackbar</h3>
        </div>
        <div className="userver-card-content">
          <p className="userver-text">
            Full snack management has moved to the dedicated SnackMachine surface.
          </p>
          <a href="/snackmachine?tab=snacks" className="userver-action-btn" style={{ display: 'inline-block', marginTop: 12 }}>
  ...
  return (
    <div className="usx-surface-layout userver-surface">
      ...
      <div className="usx-surface-body" style={{ position: 'relative' }}>
        <FilepickerSidebar open={sidebarOpen} showModeTabs sidebarMode={sidebarMode}
