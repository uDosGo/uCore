...
const FALLBACK_REGISTRY: SurfaceDef[] = [
  { id: 'terminal', name: 'Terminal', subtitle: 'BBC BASIC', description: 'BBCSDL-backed terminal with C64-style rendering and real BASIC execution.', port: 0, color: '#58a6ff', icon: 'terminal', status: 'running', embedded: true, route: '/terminal' },
  { id: 'teletext', name: 'Teletext', subtitle: 'Ceefax Viewer', description: 'Ceefax teletext page viewer with auto-fetch, page navigation, and live polling.', port: 0, color: '#d29922', icon: 'tv', status: 'running', embedded: true, route: '/teletext' },
  { id: 'ucode', name: 'uCode', subtitle: 'GridCore Surface', description: 'Unified GridCore surface with sidebar, vault picker, and grid toolset dashboard.', port: 0, color: '#39d2c0', icon: 'grid_view', status: 'running', embedded: true, route: '/ucode' },
  ...
  return (
    <div className="hub-surface">
      ...
      <div className="usx-surface-body" style={{ display: 'flex', overflow: 'hidden', position: 'relative' }}>
        <FilepickerSidebar open={sidebarOpen} />
