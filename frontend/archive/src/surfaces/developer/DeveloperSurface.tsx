...
import { FilepickerSidebar, Binder, SidebarNavItem, VaultFile } from '../../components/FilepickerSidebar'
...
// ─── Types ──────────────────────────────────────────────────────────
type DeveloperTab = 'models' | 'agents' | 'kanban' | 'repos' | 'review' | 'settings' | 'gridsmith' | 'skills' | 'usx' | 'usx-settings' | 'gridcore-settings' | 'usystem-settings' | 'rules' | 'surfaces' | 'toon-stats' | 'routing-analytics' | 'mcp-servers'
...
const DEVELOPER_TABS: DeveloperTab[] = ['models', 'agents', 'skills', 'usx', 'usx-settings', 'gridcore-settings', 'usystem-settings', 'surfaces', 'kanban', 'gridsmith', 'repos', 'review', 'rules', 'toon-stats', 'routing-analytics', 'mcp-servers', 'settings']
